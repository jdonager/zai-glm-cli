...
export interface WebSearchOptions {
  ...
  search_domain_filter?: string; // Only search specified domain
  search_recency_filter?: "day" | "week" | "month" | "year" | "noLimit";
  content_size?: "low" | "medium" | "high"; // Summary length
}
...
export class WebSearchTool {
   ...
   */
  private formatSearchResults(results: WebSearchResult[], query: string): string {
